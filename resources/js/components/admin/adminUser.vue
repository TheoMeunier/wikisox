<template>
    <div class="flex justify-end pt-4 mr-5">
        <form class="input__icon">
            ...
            <input v-model="query" type="text" class="input__icon__input w-64" id="example-search-input"
                   @keyup="searchUser" placeholder="search"/>
        </form>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <span class="relative inline-block px-3 py-1 font-semibold  leading-tight"
                                :class="user.verify === null ? 'text-red-900' : 'text-green-900' ">
                        <span class="absolute inset-0 rounded-full  opacity-50"
                            :class="false ? 'bg-red-200' : 'bg-green-200'">
                        </span>
