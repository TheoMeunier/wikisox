...
if (boldButton) {
    boldButton.addEventListener('click', () => insertText(textarea, '****', 'demo', 2, 6))
}

if (italicButton) {
    italicButton.addEventListener('click', () => insertText(textarea, '**', 'demo', 1, 5))
}

if (codeButton) {
    codeButton.addEventListener('click', () => insertText(textarea, '``````', 'demo', 3, 7))
}
...
if (linkButton) {
    linkButton.addEventListener('click', () => insertText(textarea, '[](http://...)', 'url text', 1, 9))
}
