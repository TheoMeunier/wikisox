                    ...
                    function i(e) {
                        ...
                        return (
                            2 === o
                                ...
                                : 1 === o &&
                                  ((i = (c[e.charCodeAt(t)] << 10) | (c[e.charCodeAt(t + 1)] << 4) | (c[e.charCodeAt(t + 2)] >> 2)), (a[s++] = (i >> 8) & 255), (a[s++] = 255 & i)),
                            a
                        )
                    }
                    function o(e) {
                    ...
                    ;(function (t) {
                        ...
                        function N(e, t, n) {
                            ...
                            for (var r = [], i = t; n > i; ) {
                                    ...
                                    switch (l) {
                                        ...
                                        case 3:
                                            ;(s = e[i + 1]),
                                                ...
                                                128 === (192 & s) &&
                                                    128 === (192 & c) &&
                                                    ((f = ((15 & o) << 12) | ((63 & s) << 6) | (63 & c)), f > 2047 && (55296 > f || f > 57343) && (a = f))
                                            break
                                        case 4:
                                            ;(s = e[i + 1]),
                                                (c = e[i + 2]),
                                ...
                                null === a ? ((a = 65533), (l = 1)) : a > 65535 && ((a -= 65536), r.push(((a >>> 10) & 1023) | 55296), (a = 56320 | (1023 & a))),
                                    r.push(a),
                                    (i += l)
                            }
                            return A(r)
                        ...
                        ;(n.Buffer = a),
                            ...
                            (a.prototype.indexOf = function (e, t, n) {
                                if (
                                    ('string' == typeof t ? ((n = t), (t = 0)) : t > 2147483647 ? (t = 2147483647) : -2147483648 > t && (t = -2147483648),
                                    (t >>= 0),
                                    0 === this.length)
                                )
                                    return -1
                                if (t >= this.length) return -1
                                if ((0 > t && (t = Math.max(this.length + t, 0)), 'string' == typeof e && (e = a.from(e, n)), a.isBuffer(e)))
                                          ...
                                          n.open('GET', 'https://cdn.jsdelivr.net/codemirror.spell-checker/latest/en_US.aff', !0),
                                              (n.onload = function () {
                                                  4 === n.readyState &&
                                                      ...
                                                      r.num_loaded++,
                                                      2 == r.num_loaded && (r.typo = new i('en_US', r.aff_data, r.dic_data, { platform: 'any' })))
                                              }),
                                              n.send(null)
                                      }
                                      if (!r.dic_loading) {
                ...
                function (t, n, r) {
                    !(function (t) {
                        ...
                        function U(e, t, n, r) {
                            var i = B(e, t)
                            return (
                                (t.text = t.node = i.pre), i.bgClass && (t.bgClass = i.bgClass), i.textClass && (t.textClass = i.textClass), F(t), z(e, t, n, r), q(e, t, r), t.node
                            )
                        }
                        function q(e, t, n) {
                        ...
                        function De(e, t) {
                            for (
                                var n = e.doc, r = {}, i = (r.cursors = document.createDocumentFragment()), o = (r.selection = document.createDocumentFragment()), a = 0;
                        ...
                        function en(e, t) {
                            ...
                            if (
                                !Ti(e, t) &&
                                !Gt(e.display, t) &&
                                (t.dataTransfer.setData('Text', e.getSelection()), (t.dataTransfer.effectAllowed = 'copyMove'), t.dataTransfer.setDragImage && !Lo)
                            ) {
                        ...
                        function Pn(e, t) {
                            if (!Ti(e, 'scrollCursorIntoView')) {
                                var n = e.display,
                                    ...
                                    i = null
                                if (
                                    (t.top + r.top < 0 ? (i = !0) : t.bottom + r.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null != i && !Mo)
                                ) {
                                    var o = ji(
                                        'div',
                                        '​',
                                        ...
                                        At(e, function () {
                                            Z(e, r.slice(o), n.length - o, null, l.composing ? '*compose' : null),
                                                ...
                                                l.composing &&
                                                    ...
                                                    (l.composing.range = e.markText(l.composing.start, e.getCursor('to'), { className: 'CodeMirror-composing' })))
                                        }),
                                        !0
                                    )
                                },
                                        ...
                                        function t(e) {
                                            if (!Ti(r, e)) {
                                                ...
                                                if (e.clipboardData && !No)
                                                    e.preventDefault(), e.clipboardData.clearData(), e.clipboardData.setData('text/plain', Fo.text.join('\n'))
                                                else {
                                                    var n = re(),
                                                        i = n.firstChild
                            ...
                            column: function () {
                                return (
                                    this.lastColumnPos < this.start &&
                                        ((this.lastColumnValue = Fa(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue)),
                                        (this.lastColumnPos = this.start)),
                                ...
                                e &&
                                    ...
                                    At(n, function () {
                                        var r = e.line,
                                            ...
                                            o = Qe(n, i)
                                        if (
                                            (o && (ot(o), (n.curOp.selectionChanged = n.curOp.forceUpdate = !0)), (n.curOp.updateMaxLine = !0), !kr(t.doc, r) && null != t.height)
                                        ) {
                                            var a = t.height
                                            t.height = null
                                            var l = Lr(t) - a
                            ...
                            function (t, n) {
                                ...
                                function s(t, o) {
                                    ...
                                    if ((f = t.match(A)) && f[1].length <= 6)
                                        return (o.header = f[1].length), n.highlightFormatting && (o.formatting = 'header'), (o.f = o.inline), h(o)
                                ...
                                function c(t, n) {
                                    ...
                                    if (!k) {
                                        ...
                                        ;(('xml' == i.mode.name && null === i.state.tagStart && !i.state.context && i.state.tokenize.isInText) ||
                            ...
                            function y(e, t, n) {
                                ...
                                if ('endTag' == e || 'selfcloseTag' == e) {
                                    ...
                                    return (
                                        ...
                                        'selfcloseTag' == e || S.autoSelfClosers.hasOwnProperty(r) ? h(n, r) : (h(n, r), (n.context = new u(n, r, i == n.indented))),
                                        d
                                    )
                                }
                                return (M = 'error'), y
                    ...
                    ;(function (t) {
                        ;(function () {
                            ...
                            ;(d.bullet = /(?:[*+-]|\d+\.)/),
                                ...
                                (d.html = c(d.html)('comment', /<!--[\s\S]*?-->/)('closed', /<(tag)[\s\S]+?<\/\1>/)('closing', /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(
                                    /tag/g,
                                    d._tag
                                )()),
                                (d.paragraph = c(d.paragraph)('hr', d.hr)('heading', d.heading)('lheading', d.lheading)('blockquote', d.blockquote)('tag', '<' + d._tag)(
                                    'def',
                                    d.def
                                )()),
                                (d.normal = f({}, d)),
                                ...
                                (t.prototype.token = function (e, t, n) {
                                    for (var r, i, o, a, l, s, c, u, f, e = e.replace(/^ +$/gm, ''); e; )
                                        if (
                                            ...
                                            (e = e.substring(o[0].length)), this.tokens.push({ type: 'heading', depth: '=' === o[2] ? 1 : 2, text: o[1] })
                                            ...
                                            (e = e.substring(o[0].length)), (this.tokens.links[o[1].toLowerCase()] = { href: o[2], title: o[3] })
                    ...
                    function h(e) {
                        ...
                        if ('single' === p) {
                            ...
                            if (u.line !== f.line || u.ch !== f.ch) {
                                ...
                                var S = u.line
                                if (
                                    (t(c.getLineHandle(u.line)) && ('fenced' === r(c, u.line + 1) ? ((o = u.line), (S = u.line + 1)) : ((a = u.line), (S = u.line - 1))),
                                    void 0 === o)
                                )
                    ...
                    ;(B.prototype.markdown = function (e) {
                        ...
                        (B.prototype.createSideBySide = function () {
                            ...
                            ;(n && /editor-preview-side/.test(n.className)) ||
                                ((n = document.createElement('div')), (n.className = 'editor-preview-side'), t.parentNode.insertBefore(n, t.nextSibling))
                            var r = !1,
                                i = !1
                            return (
